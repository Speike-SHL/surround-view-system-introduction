...
def main():
    ...
    # image_dir = Path(cfg.data_root) / 'testing' / 'outdoor-rainy'
    # image_dir = Path(cfg.data_root) / 'testing' / 'outdoor-shadow'
    # image_dir = Path(cfg.data_root) / 'testing' / 'outdoor-slanted'
    image_dir = Path(cfg.data_root) / 'testing' / 'outdoor-street light'
